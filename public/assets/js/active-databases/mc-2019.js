...
if (window.location.href.indexOf('http://localhost:3000/mc2019') != -1) {
    ...
    let fireConfig = {
        ...
        authDomain: "mc-2019.firebaseapp.com",
        databaseURL: "https://mc-2019.firebaseio.com/",
        projectId: "mc-2019",
        storageBucket: "mc-2019.appspot.com",
        messagingSenderId: "819456042021",
        appId: "1:819456042021:web:73c9f54d8badc627318bcc",
        measurementId: "G-WG77ELCK7J"
    };
    ...
    let mc2019 = firebase.database().ref('mc-2019/' + fPath);
    ...
    btnUpload.addEventListener('change', function (e) {
        ...
        // File dump path.
        const uploadPath = firebase.storage().ref('excel-macros/' + file.name);
    ...
    function saveFile(fName, fLink, fDate, fSize) {
        const newMessageRef = mc2019.push();
        newMessageRef.set({
            fName: fName,
            fLink: fLink,
            fDate: fDate,
    ...
    const userDataRef = firebase.database().ref("mc-2019/" + fPath).orderByKey();
            ...
            snapshot.forEach(function (childSnapshot) {
                ...
                if (fPath == "" || " " || null) {
                    ...
                    for (let i = 0; i < key.length; ++i) {
                        let buttons = $('<a href="http://localhost:3000/mc2019/"><button style="font-size: 150%; margin-top: 10px; width: 100%; height: 50px;"><i class="fa fa-folder text-warning float-left" aria-hidden="true"></i> <b class="text-primary">' + key + '</b></button><br />')
